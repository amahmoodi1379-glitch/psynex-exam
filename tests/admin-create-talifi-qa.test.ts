...
async function run() {
  ...
  konkurForm.set("opt1", "A1");
  konkurForm.set("opt2", "B1");
  konkurForm.set("opt3", "C1");
  konkurForm.set("opt4", "D1");
  ...
  talifiForm.set("opt1", "TA");
  talifiForm.set("opt2", "TB");
  talifiForm.set("opt3", "TC");
  talifiForm.set("opt4", "TD");
