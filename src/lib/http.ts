...
<head>
  ...
  <style>
    body{font-family:"Vazirmatn","IRANSans","IRANYekan","Tahoma",system-ui,-apple-system,"Segoe UI",Roboto;max-width: 960px;margin:24px auto;padding:0 16px;line-height:1.7}
